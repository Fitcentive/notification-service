...
insert into template (name, description) values ('UserFollowRequest', 'Notification type when user A requests to follow user B');
...
create table notification_data (
    ...
    has_been_interacted_with not null default false,
    data jsonb,
