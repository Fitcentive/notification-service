...
- `gcloud container images delete gcr.io/fitcentive-dev-03/notification:1.0 --force-delete-tags`
...
== Mailjet setup
1. Create account
2. Create API key + secret - https://app.mailjet.com/account/relay
3. Validate domain and use email as @validated.domain
